        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    RestaurantId = table.Column<long>(nullable: true),
                    NumberTable = table.Column<long>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TablesRestaurant_Restaurants_RestaurantId",
                        column: x => x.RestaurantId,
                        principalTable: "Restaurants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    NumberReservation = table.Column<long>(nullable: false),
                    RestaurantId = table.Column<long>(nullable: true),
                    EmployeeId = table.Column<long>(nullable: true),
                    TableRestaurantId = table.Column<long>(nullable: true),
                    TimeReservation = table.Column<DateTime>(nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TablesRestaurant_RestaurantId",
